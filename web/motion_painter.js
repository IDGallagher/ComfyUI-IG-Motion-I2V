...
class Painter {
  ...
  makeElements() {
    ...
    this.strokeColorTransparent = 1.0
    this.fillColorTransparent = 1.0
...
function PainterWidget(node, inputName, inputData, app) {
  ...
  node.painter.selectPropertyToolbar(node.painter.type);
  node.painter.changePropertyBrush(node.painter.type);
